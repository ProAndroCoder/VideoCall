...
class ChatLogActivity : AppCompatActivity() {
    ...
    private lateinit var mAlertDialog: android.app.AlertDialog
    ...
    private fun performSendMessage() {
        ...
        if (fromId == null || text.isEmpty() || user == null) {
    ...
    private fun performSendAttachment() {
        if (fromId == null || attachmentName.isEmpty() || attachmentType.isEmpty()) {
        ...
        Log.d(logTAG, fileUri.toString())

        val chatMessage = ChatMessage("", fromId, toId, sendingTime, attachmentUrl, attachmentName, attachmentType, fileUri.toString())

        adapter.add(ChatFromItem(chatMessage, mUser))
    }
